    ...
    return (
      <div className="card">
        <div className="card__header">
          ...
          >
            <path d="M3.42857 6.85716H2.28572V8.00002H3.42857V6.85716Z" fill="white" fillOpacity="0.6" />
            <path d="M5.14286 6.85716H4V8.00002H5.14286V6.85716Z" fill="white" fillOpacity="0.6" />
            <path d="M6.85714 6.85716H5.71429V8.00002H6.85714V6.85716Z" fill="white" fillOpacity="0.6" />
            <path d="M8.57143 6.85716H7.42857V8.00002H8.57143V6.85716Z" fill="white" fillOpacity="0.6" />
            <path d="M5.14286 5.14284H4V6.28569H5.14286V5.14284Z" fill="white" fillOpacity="0.6" />
            <path d="M6.85714 5.14284H5.71429V6.28569H6.85714V5.14284Z" fill="white" fillOpacity="0.6" />
            <path d="M8.57143 5.14284H7.42857V6.28569H8.57143V5.14284Z" fill="white" fillOpacity="0.6" />
            <path d="M3.42857 8.57144H2.28572V9.7143H3.42857V8.57144Z" fill="white" fillOpacity="0.6" />
            <path d="M5.14286 8.57144H4V9.7143H5.14286V8.57144Z" fill="white" fillOpacity="0.6" />
            <path d="M6.85714 8.57144H5.71429V9.7143H6.85714V8.57144Z" fill="white" fillOpacity="0.6" />
            <path d="M8.57143 8.57144H7.42857V9.7143H8.57143V8.57144Z" fill="white" fillOpacity="0.6" />
            <path d="M10.2857 6.85716H9.14286V8.00002H10.2857V6.85716Z" fill="white" fillOpacity="0.6" />
            <path d="M10.2857 5.14284H9.14286V6.28569H10.2857V5.14284Z" fill="white" fillOpacity="0.6" />
            <path
