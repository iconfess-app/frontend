...
class CardConfession extends Component {
  ...
  handleUnlike = () => {
    confessionService
      .unlikeConfession(this.props.id)
      .then(confession => {
        this.setState({
          likes: [...confession.likes],
          liked: false,
        ...
        <div className="card-footer">
          ...
          {this.state.liked && (
            <div onClick={this.handleUnlike}>
              <img src="/images/icon-liked.png" alt="liked full heart" />
            </div>
          )}
          {!this.state.liked && (
            <div onClick={this.handleLike}>
              <img src="/images/icon-unliked.png" alt="unliked empty heart" />
            </div>
          )}
