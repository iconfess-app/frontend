      ...
      <nav>
        <div className="navbar">
          <NavLink to="/" exact activeClassName="current">
            ...
            <span className="current-label">Home</span>
          </NavLink>
          <NavLink to="/privacy-policy" exact activeClassName="current">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="current-label">Policy</span>
          </NavLink>
          <NavLink to="/confess" exact className="add-btn">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <NavLink to="/myconfessions" exact activeClassName="current">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <NavLink to="/edit" exact activeClassName="current">
            ...
            <span className="current-label">Profile</span>
          </NavLink>
        </div>
      </nav>
    );
